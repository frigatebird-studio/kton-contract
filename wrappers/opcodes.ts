...
export const JETTON_PROVIDE_WALLET_ADDRESS = 0x2c76b973;
export const JETTON_TAKE_WALLET_ADDRESS = 0xd1735400;
export const JETTON_BURN_REDEEM_OPCODE = 0x6d88d6dd;
